...
Trabajaremos con los datos de Casen. Escriba una función llamada `count_something` que agrupe por una variable y sume otra. Por ejemplo, `count_something(casen, region, ytotcor)` debería devolver lo siguiente:
...
count_something(casen, region, ytotcor) %>% slice(1:3)
